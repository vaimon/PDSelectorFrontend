        ...
        <section className="how-section" aria-labelledby="how-paths-title">
          ...
          <div className="how-paths">
            ...
            <article className="how-path">
              <h3>Войти в чужую</h3>
              <p>
                Посмотрите команды в каталоге и подайте заявку — её решает тимлид. Если вас уже
                позвали, приглашение ждёт на странице «Заявки», а ссылка из чата приведёт в команду
                сразу, без заявки.
              </p>
